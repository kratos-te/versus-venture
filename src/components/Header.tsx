    ...
    return (
        <header className="py-12 px-24 absolute left-0 top-0 w-full z-50 bg-gradient-to-b from-gray-900 to-black border-b-[1px] border-main">
            <div className="flex items-center max-w-[1440px] justify-between mx-auto relative">
                            ...
                            {HEADER_LINK.map((item, key) => (
                                <li key={key}>
                                    <MenuButton
                                        ...
                                        title={item.title}
                                        link={item.link}
                                        onClick={() => handleShowMenu(item.title)}
                                    />
                                </li>
                            ))}
                        </ul>
                ...
                {isEcosystem && (
                    <div className="w-48 rounded-2xl bg-dark-200 z-10 absolute top-14 right-[500px] max-lg:hidden">
                ...
                {isAbout && (
                    <div className="w-48 rounded-2xl bg-dark-200 z-10 absolute top-14 right-4 max-lg:hidden ">
                        <div className="flex flex-col gap-[20px] p-6">
