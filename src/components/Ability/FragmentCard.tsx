...
const FramgmentCard: FC<FragmentProps> = ({ title, icon, description }) => {
    return (
        <>
            ...
            <div className="flex flex-col rounded-[25px] gap-[50px] py-[109px] px-[66px] bg-gradient-to-t from-[#111] to-[#0B0B0B] border-[1px] border-[#3A3A3A] mv:hidden max-md:gap-[25px] max-md:px-[55px] max-md:py-[100px] max-md:w-[400px]">
                <Image src={icon} alt="fragment" width={100} height={115} />
                <div className="flex flex-col gap-[20px]">
                    <div className="flex text-[20px] font-rubik font-semibold text-white max-md:text-[16px]">
                        {title}
                    </div>
                    <div className="flex text-[14px] font-rubik font-normal text-white max-md:text-[12px]">
                        {description}
                    </div>
                </div>
            </div>
