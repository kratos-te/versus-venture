...
const VisionFeature: FC = () => {
    return (
        <div className="flex py-[150px] px-24 max-lg:px-12 relative max-lg:py-0">
            <div className="flex items-center max-w-[1440px] justify-end mx-auto mb-[200px] max-lg:mb-0">
                <img src={"./svg/planet.svg"} className="absolute left-0 bottom-[1000px] pointer-events-none w-full flex-col items-center justify-center object-cover opacity-80 lg:opacity-100 z-0" alt="vision" />
                <div className="flex flex-col gap-[150px] z-10">
                    <div className="flex justify-between">
                        <Sunrise className="max-lg:hidden" />
                        <div className="flex flex-col w-1/2 gap-[50px] max-lg:w-full z-20">
                    ...
                    <div className="flex justify-between">
                        ...
                        <img src={"./img/system.png"} className="absolute right-0 -top-60 pointer-events-none w-full object-cover opacity-80 lg:opacity-100 max-lg:top-10 max-xl:top-40 max-xld:top-20  max-lg:hidden" alt="system" />
                    </div>
                    ...
                    <div className="flex justify-end">
                        <img src={"./img/building.png"} className="absolute pointer-events-none object-cover left-0 bottom-80 pl-24 max-lg:hidden" alt="hero" />
                        <div className="flex flex-col w-1/2 gap-[50px] max-xl:pl-[50px] max-lg:w-full">
