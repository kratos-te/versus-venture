            ...
            <div className="flex items-center max-w-[1440px] justify-end mx-auto mb-[200px] max-lg:mb-0">
                ...
                <div className="flex flex-col gap-[150px] z-10">
                    ...
                    <div className="flex justify-between">
                        ...
                        <img src={"./img/system.png"} className="absolute right-0 -top-80 pointer-events-none w-full object-cover opacity-80 lg:opacity-100 max-xl:top-40  max-lg:hidden" alt="system" />
                    </div>
                    ...
                    <div className="flex justify-end">
                        <img src={"./img/building.png"} className="absolute pointer-events-none object-cover left-0 pl-24 max-lg:hidden" alt="hero" />
