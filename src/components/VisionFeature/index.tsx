    ...
    return (
        <div className="flex py-[150px] px-24">
            <div className="flex items-center max-w-[1440px] justify-end mx-auto mb-[200px] relative">
                <img src={"./svg/planet.svg"} className="absolute left-0 -top-16 pointer-events-none w-full flex-col items-center justify-center object-cover opacity-80 lg:opacity-100 z-0" alt="vision" />
                <div className="flex flex-col gap-[150px] z-10">
                    ...
                    <div className="flex justify-between">
                        ...
                        <img src={"./img/system.png"} className="absolute pointer-events-none w-full object-cover opacity-80 lg:opacity-100 " alt="system" />
                    </div>
                    ...
                    <div className="flex gap-[30px] justify-between">
                        <img src={"./svg/building.svg"} className="pointer-events-none w-1/2 object-cover opacity-80 lg:opacity-100 " alt="hero" />
                        <div className="flex flex-col w-1/2 gap-[50px]">
